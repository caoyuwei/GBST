...
class gbstModel(gbstModelBase):
    ...
    def __init__(self, max_depth=5, learning_rate=0.1, n_estimators=100,
    ...
    def score(self, X, y, sample_weight=None):
        ...
        y_arr = np.zeros([hazards.shape[0], hazards.shape[1]])
        ...
        for timestep in range(0, hazards.shape[1]):
            ...
            try:
                ...
                pass
        return float(np.sum(auc_total)) / len(auc_total)
